...
const SearchGames = lazy(() => import('../pages/Games/SearchGames'))
const MyGames = lazy(() => import('../pages/Games/MyGames'))
...
const routes = [
  ...
  <AuthorizedRoute path='/search_games' exact component={SearchGames} />,
  <AuthorizedRoute path='/my_games' exact component={MyGames} />,
  <AuthorizedRoute
